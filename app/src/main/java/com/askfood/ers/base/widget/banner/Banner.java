...
import com.askfood.ers.base.handler.WeakHandler;
...
public class Banner  extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public Banner setViews(List<View> views) {
    ...
    public Banner start() {
        setBannerStyleUI();
        setImageList(imageViews);
        setData();
        return this;
    }

    private void setTitleStyleUI() {
        if (titles.size() != imageViews.size()) {
    ...
    private void setImageList(List<View> views) {
