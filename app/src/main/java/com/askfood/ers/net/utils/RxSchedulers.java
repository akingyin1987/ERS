...
package com.askfood.ers.net.utils;


import com.askfood.ers.net.RxException;
import com.askfood.ers.net.exception.ApiException;
...
public class RxSchedulers {
  ...
  public   void    demo(){
   ApiResult<String> apiResult = new ApiResult<>();
    Observable.just(apiResult).compose(RxSchedulers.<ApiResult<String>>IO_Main())
